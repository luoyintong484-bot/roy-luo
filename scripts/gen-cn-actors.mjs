...
const ACTORS = [
  ...
  ['张凌赫','male','1997-12-30','演员','个人工作室','?',93,'2025年度热度演员·95后待播热度TOP2'],
  ...
  ['宋祖儿','female','1998-05-23','演员','个人工作室','?',90,'2026年度飞跃演员·95后待播热度TOP3'],
  ['赵今麦','female','2002-09-29','演员','个人工作室','?',92,'2025年00后演员热度榜第1'],
  ['周也','female','1998-05-20','演员','个人工作室','?',90,'2026年度表现力影人·95后待播热度TOP2'],
...
// ---- 幂等：先删除 artists.ts 中已存在的 id 924-963 段（旧版内娱艺人）----
let removed = 0;
for (let i = 924; i <= 963; i++) {
